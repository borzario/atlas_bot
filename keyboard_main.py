...
bo = KeyboardButton("/Для_оптовых_заказов")
bok = KeyboardButton("/О_компании_АТЛАС")
bovt = KeyboardButton("/Обратиться_в_поддержку")
...
b3 = KeyboardButton("/ДополнительнаяЗащита")
b4 = KeyboardButton("/МоиЗаказы")
kb_client = ReplyKeyboardMarkup(resize_keyboard=True)
kb_client.row(b1, b2).add(b3).row(b4, b_start)
b5 = KeyboardButton("/ИзменитьДанныеПолучателя")
